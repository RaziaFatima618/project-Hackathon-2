...
const NewsLetterSection = () => {
  return (
    <div className="relative grid grid-cols-1 md:grid-cols-2 py-9 md:py-11 px-6 md:px-16 max-w-frame mx-auto bg-black/80 rounded-[40px]">
      <p
        className={cn([
          integralCF.className,
          "font-bold text-[25px] md:text-[px] text-white mb-9 md:mb-0",
        ])}
      >
