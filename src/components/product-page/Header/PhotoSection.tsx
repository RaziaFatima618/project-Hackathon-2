    ...
    <div className="flex flex-col-reverse lg:flex-row lg:space-x-3.5">
          ...
          {data.gallery.map((photo, index) => (
            ...
            >
              <Image
                ...
                width={152}
                height={167}
                className="rounded-md w-full h-full object-cover hover:scale-50 transition-all duration-200"
                alt={data.title}
                priority
              />
            </button>
      ...
      <div className="flex items-center justify-center bg-[#F0EEED] rounded-[13px] sm:rounded-[20px] w-full sm:w-96 md:w-full mx-auto h-full max-h-[530px] min-h-[330px] lg:min-h-[380px] xl:min-h-[530px] overflow-hidden mb-3 lg:mb-0">
        <Image
          ...
          width={444}
          height={530}
          className="rounded-md w-full h-full object-cover hover:scale-80 transition-all duration-300"
          alt={data.title}
          priority
          unoptimized
        />
